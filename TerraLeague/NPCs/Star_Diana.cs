...
{
    public class Star_Diana : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Shimmer of Dusk");
        }
        ...
        public override void AI()
        {
            ...
            else if (CurrentState == State_Attack)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    Dust dust = Dust.NewDustDirect(npc.position, npc.width, npc.height, 263, 0, 0, 150, TargonBoss.DianaColor);
                    dust.noGravity = true;
                    dust.velocity *= 2;
                }
            }
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life > 0)
            {
                ...
                {
                    Dust dust = Dust.NewDustDirect(npc.position, npc.width, npc.height, 263, 0f, 0f, 0, TargonBoss.DianaColor, 1.5f);
                    dust.noGravity = true;
                    count++;
                    break;
                }
