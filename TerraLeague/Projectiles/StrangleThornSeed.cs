...
{
    class StrangleThornSeed : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            pos.Y += 12;
            pos.X -= 16;
            Projectile.NewProjectileDirect(pos, Vector2.Zero, ProjectileType<NightBloomingZychidsBulb>(), projectile.damage, projectile.knockBack, projectile.owner);
        }
