...
{
    public class Pyroclasm : ModProjectile
    {
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            ...
            {
                crit = true;
                Projectile.NewProjectileDirect(target.Center, Vector2.Zero, ProjectileType<PyroclasmExplosion>(), projectile.damage / 2, 5, projectile.owner);
            }
