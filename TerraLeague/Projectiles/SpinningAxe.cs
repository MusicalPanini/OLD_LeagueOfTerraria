...
{
    public class SpinningAxe : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectileDirect(projectile.oldPosition, new Vector2((distance * 0.013f) + (Main.player[projectile.owner].velocity.X * 0.6f), -12), ProjectileType<CatchingAxe>(), 0, 0, projectile.owner, projectile.spriteDirection);
