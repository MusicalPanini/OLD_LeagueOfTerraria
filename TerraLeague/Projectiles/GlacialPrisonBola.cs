...
{
    public class GlacialPrisonBola : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile proj = Projectile.NewProjectileDirect(projectile.Center, Vector2.Zero, ProjectileType<GlacialStorm>(), projectile.damage, 0, projectile.owner);
